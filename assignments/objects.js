...
// Mitzi's name
const firstIntern = mitzi.name;
console.log(firstIntern);

// Kennan's ID
const secondIntern = kennan.id;
console.log(secondIntern);

// Keven's email
const thirdIntern = keven.email;
console.log(thirdIntern);

// Gannie's name
const fourthIntern = gannie.name;
console.log(fourthIntern);

// Antonietta's Gender
const fifthIntern = antonietta.gender;
...
const parent = {
  ...
  child: {
    ...
    age: 50,
    speak: function() {
      return `I'm George and I'm ${this.age} years old.`;
    },
    grandchild: {
      name: 'Sam',
      age: 30,
