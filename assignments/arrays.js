...
let lastCar = 0;
// console.log(inventory.pop(lastCar[49]));
console.log(
  `The last car on the inventory list is a ${inventory[49].car_make} ${
...
inventory.sort(function(a, b) {
  let car_modelA = a.car_model;
  let car_modelB = b.car_model;
...
// let carYears = [];
const carYears = inventory.map(function(years) {
...
// 1. set oldCars to equal carYears array I just made above
// 2. use .sort method to sort the car years and figure out the index position I need
// 3. use the .splice method to splice the now sorted array at the index I specify
let oldCars = carYears.sort().splice(24);
